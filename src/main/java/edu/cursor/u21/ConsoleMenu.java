...
public class ConsoleMenu {
    ...
    public void ConsoleMenu() throws IOException {
        String r = U21ReaderMethods.readFile();
        String[] r1 = U21ReaderMethods.deleteMatchesAndPrepositions(r);
...
//                try {
            ...
            switch (operator) {
                case 1:
                    U21ReaderMethods.deleteMatchesAndPrepositions(r);
                    break;
                case 2:
                    U21ReaderMethods.checkOnTheNumberOfWords(r1);
                    break;
                case 3:
...
//                    methods.displayWordsStatistics(reader);
                ...
                case 4:
                    ...
                    U21ReaderMethods.findFrequencyOfWord(word, r1);
                    U21ReaderMethods.findSimilarWords(word, r1);
                    break;
                case 5:
